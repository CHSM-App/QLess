...
List<AppointmentList> _filtered(
  ...
  Widget build(BuildContext context) {
    ...
    final upcomingAppointments =
        _filtered(allAppointments, isCompleted: false);
    final completedAppointments =
        _filtered(allAppointments, isCompleted: true);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(children: [
            _headerBadge('$upcomingCount Upcoming', Colors.white24),
            const SizedBox(width: 8),
            _headerBadge('$completedCount Done', Colors.white12),
          ]),
        ],
      ),
    );
  ...
  Widget _buildPatientListAsync(
    ...
    return appointmentsAsync.when(
      ...
      data: (list) {
        final filtered = _filtered(list, isCompleted: isCompleted);
        return _buildPatientList(filtered, isCompleted: isCompleted);
      },
    );
  }
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            CircleAvatar(
              ...
              child: Text(
                _initials(name),
                style: TextStyle(
                    fontSize: 14, fontWeight: FontWeight.w600, color: avatarText),
              ),
            ),
            ...
            Expanded(
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Container(
                  ...
                  child: Text(status,
                      style: TextStyle(
                          fontSize: 10, fontWeight: FontWeight.w600, color: ss.text)),
                ),
              ]),
              const SizedBox(height: 5),
              Wrap(spacing: 8, runSpacing: 4, children: [
                _infoChip(Icons.person_outline, _ageGender()),
                _infoChip(Icons.calendar_today, patient.appointmentDate ?? '-'),
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Text('${patient.appointmentId ?? '-'}',
...
Row(children: [
  ...
  Widget _outlineBtn(String label, IconData icon, VoidCallback onTap) => Expanded(
        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              _detailTile(Icons.person_outline, 'Age & Gender', _ageGender()),
              _detailTile(Icons.calendar_today, 'Appointment Date',
                  patient.appointmentDate ?? '-'),
              _detailTile(Icons.confirmation_number_outlined, 'Queue Number',
                  '${patient.queueNumber ?? '-'}'),
              ...
              if (!_isTerminalStatus(patient.status))
                SizedBox(
                  width: double.infinity,
