  ...
  List<Map<String, dynamic>> appointments = [
    {
      ...
      "image": "https://images.unsplash.com/photo-1706565029539-d09af5896340",
    },
    {
    ...
    },
    {
      ...
      "image": "https://images.unsplash.com/photo-1606811801193-e318c9a87ad7",
    },
  ];
  ...
  Widget build(BuildContext context) {
    final filtered = appointments.where((a) {
      final matchSearch =
          ...
          a["specialization"].toLowerCase().contains(searchQuery.toLowerCase());

      final matchFilter = filterStatus == "all" || a["status"] == filterStatus;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [kGreen, Color(0xFFC8E6C9)]),
