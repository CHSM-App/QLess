      ...
      case _QueueState.opensSoon:
        ...
        if (d.isSlotAvailable == 1) {
          return _QueueStatus(
              ...
              label: lbl, btnLabel: 'Book',
              color: kWarning, icon: Icons.schedule_rounded);
        }
        return _QueueStatus(
            isVisible: true, canBook: false, tintCard: false,
            label: lbl, btnLabel: 'Soon',
            color: kWarning, icon: Icons.schedule_rounded);
      case _QueueState.full:
        return const _QueueStatus(
            isVisible: true, canBook: false, tintCard: true,
            label: 'Queue full', btnLabel: 'Full',
            color: kError, icon: Icons.group_off_rounded);
...
class _SpecChip extends StatelessWidget {
  ...
  const _SpecChip({
    ...
    required this.accent,   required this.bg,
    required this.onTap,
  });
