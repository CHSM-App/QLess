...
//             boxShadow: [
//               BoxShadow(color: Colors.black.withValues(alpha: 0.16), offset: const Offset(0, 8), blurRadius: 24, spreadRadius: -4),
//               BoxShadow(color: Colors.black.withValues(alpha: 0.06), offset: const Offset(0, 2), blurRadius: 6),
//             ],
//           ),
//           child: LayoutBuilder(
...
//                           border: Border.all(color: DoctorNavTheme.tealLight, width: 1),
//                         ),
//                       ),
//                     ),
