...
class DoctorExploreScreenState extends ConsumerState<DoctorExploreScreen>
  ...
  // ════════════════════════════════════════════════════════════════════
  //  HEADER  — flat white header (matches app-wide header style)
  // ════════════════════════════════════════════════════════════════════
  Widget _buildHeader() {
    return Container(
      decoration: const BoxDecoration(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              // Filter icon button — commented out per request
              // const SizedBox(width: 10),
              // _HeaderBtn(
              //   icon: Icons.tune_rounded,
              //   onTap: () => _goToSearch(context),
...
// ════════════════════════════════════════════════════════════════════
//  HEADER BUTTON  — soft rounded square, teal-tinted on tap
//  (kept for reuse elsewhere even though the filter button above is
