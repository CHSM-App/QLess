...
// // // ── Neomorphism helper ──────────────────────────────────────────────
// // // Soft-UI surfaces: a light shadow (upper-left) + a dark shadow (lower-right)
// // // on a surface colour matching the page background, so raised elements read
// // // as embossed rather than as flat cards with a drop shadow.
// // const _kNeoLight = Color(0xFFFFFFFF);
// // const _kNeoDark = Color(0xFFCDD5DE);
...
// //     border: border ?? Border.fromBorderSide(const BorderSide(color: _kCardBorder)),
// //     boxShadow: pressed
// //         ? const [
// //             BoxShadow(color: _kNeoDark, offset: Offset(2, 2), blurRadius: 4, spreadRadius: -2),
// //           ]
// //         : const [
// //             BoxShadow(color: _kNeoDark, offset: Offset(4, 4), blurRadius: 8),
// //             BoxShadow(color: _kNeoLight, offset: Offset(-4, -4), blurRadius: 8),
// //           ],
// //   );
// // }
