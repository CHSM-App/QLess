...
DoctorDetails _$DoctorDetailsFromJson(Map<String, dynamic> json) =>
    DoctorDetails(
      ...
      isverified: (json['doc_is_verified'] as num?)?.toInt(),
      ...
      isOnLeave: _intFromJson(json['is_on_leave']),
      ...
      reviewCount: _intFromJson(json['review_count']),
...
Map<String, dynamic> _$DoctorDetailsToJson(DoctorDetails instance) =>
    <String, dynamic>{
      ...
      'doc_is_verified': instance.isverified,
